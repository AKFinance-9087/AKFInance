...
const translations = {
  ...
  tanglish: {
    ...
    loans: 'Loans (கடன்கள்)',
    collections: 'Collections (வசூல்)',
    reports: 'Reports (அறிக்கைகள்)',
    calendar: 'Calendar',
    settings: 'Settings (அமைப்புகள்)',
    logout: 'Logout (வெளியேறு)',
    expenses: 'Expenses (செலவுகள்)',
    employees: 'Employees (ஆட்கள்)',

    // Navbar
    search_placeholder: 'Customer, loan, phone number search seiyya...',
    notifications: 'Notifications',
    pending_count: 'Pending',
    no_pending_notifications: 'Ippo pending vasool edhum illai!',
    super_admin: 'Super Admin',
    loan_bal: 'Kadan Baaki',
    ...
    save: 'Save',
    submit: 'Submit',
    loading: 'Loading aagudhu...',
    all: 'Ellam (All)',
    daily: 'Daily',
    weekly: 'Weekly',
    monthly: 'Monthly',
    active: 'Active',
    overdue: 'Overdue (பாக்கி)',
    ...
    financial_overview_desc: 'Ungal daily lending, vatti matrum vasoolai live-ah kankaani.',
    total_principal_disbursed: 'Moththa Muthaleedu',
    total_principal_disbursed_sub: 'Kadanaaga koduththa moththa muthal',
    total_collected: 'Moththa Vasool',
    total_collected_sub: 'Vandhadhaana asal matrum vatti',
    total_interest_earned: 'Moththa Vatti Income',
    total_interest_earned_sub: 'Total vatti labam',
    active_loans_count: 'Active Kadangal',
    active_loans_count_sub: 'Ippo odikittu irukkum kadangal',
    quick_actions: 'Quick Actions',
    add_customer: 'Customer Serka',
    create_loan: 'Kadan Podunga',
    record_payment: 'Vasool Pathivu',
    generate_report: 'Report Edukka',
    critical_overdue_loans: 'Mukkiya Pending Kadangal',
    no_overdue_loans: 'Pending kadangal edhum illai. Ella vasoolum correct-ah pogudhu!',
    view_in_collections: 'Collections-il Paarkka',
    loan_distribution: 'Kadan Distribution',
    recent_collections: 'Recent Vasoolgal',
    view_all: 'Ellathaiyum Paarkka',
    no_recent_collections: 'Innum vasool edhum record seiyavillai.',

    // Customers Page
    customer_directory: 'Customers List',
    customer_directory_desc: 'Kadan vaangiyavargalai nirvagikka matrum avanga status-ai paarkka.',
    search_customers: 'Peyar, phone, loan ID, illai oor vachu search seiyya...',
    filter_status: 'Ella Status-um',
    filter_frequency: 'Ella Frequency-um',
    customer_col: 'Customer',
    active_loans_col: 'Active Kadangal',
    principal_col: 'Asal (Principal)',
    remaining_balance_col: 'Meedhi Baaki',
    next_due_col: 'Adutha Thavanai',
    no_customers_found: 'Intha filter-la customers yaarume illai.',

    // Add / Edit Customer Modal
    add_new_customer: 'Pudhiya Customer & Kadan Serka',
    edit_customer: 'Customer Details Edit Seiyya',
    customer_name: 'Customer Muzhu Peyar',
    phone_number: 'Phone Number',
    business_location: 'Oor / Address',
    loan_amount: 'Kadan Amount (₹)',
    interest_rate: 'Vatti Rate (%)',
    interest_rate_placeholder: '10 (Default)',
    interest_period: 'Vatti Kaalam (Period)',
    start_date: 'Kadan Thodangiya Date',
    create_customer_button: 'Customer Create Seithu Kadan Kodukka',
    save_changes: 'Save Seiyya',
    calculated_preview: 'Calculated Vatti (வட்டி)',

    // Customer Profile
    customer_profile: 'Customer Profile',
    back_to_customers: 'Customers Page-ukku Thirumba',
    phone_label: 'Phone Number',
    location_label: 'Oor / Address',
    customer_since: 'Join Panna Date',
    loan_details: 'Kadan Vivaram',
    total_loan_amount: 'Moththa Kadan Amount',
    remaining_principal: 'Meedhi Asal Baaki',
    total_paid: 'Moththam Kattiyadhu',
    payment_history: 'Vasool History',
    no_payments_yet: 'Intha customer innum payment edhum kattala.',
    add_payment_modal_title: 'Vasool Pathivu Seiyya',

    // Collections Page
    daily_collections: 'Daily Vasool',
    daily_collections_desc: 'Daily, weekly matrum monthly kadan vasoolai pathivu seiyya.',
    search_collections: 'Customer peyar, phone, loan ID thedu...',
    due_today: 'Inaikki Varavendiyathu',
    collected_today: 'Inaikki Vasoolaanathu',
    pending_today: 'Inaikki Pending Baaki',
    collect: 'Vasoolika',
    payment_type: 'Payment Type',
    interest_only: 'Vatti Mattum',
    principal_only: 'Asal Mattum',
    interest_due: 'Pending Vatti',
    principal_due: 'Pending Asal',
    amount_received: 'Vaangiya Amount (₹)',
    payment_mode: 'Eppadi Koduthanga (Mode)',
    cash: 'Cash (ரொக்கம்)',
    upi: 'UPI / GPay',
    bank_transfer: 'Bank Transfer',
    full_principal: 'Full Asal',
    submit_payment: 'Vasoolai Submit Seiyya',

    // Reports Page
    financial_reports: 'Finance Reports',
    financial_reports_desc: 'Collections, labam matrum business analytics vivarangal.',
    net_profit: 'Net Labam / Vatti',
    default_rate: 'Pending Rate (%)',
    monthly_trends: 'Maadha Vasool Trend',
    collection_efficiency: 'Vasool Efficiency',
    export_csv: 'Data Download Seiyya',

    // Settings Page
    settings_title: 'Settings (அமைப்புகள்)',
    settings_desc: 'Ungal account details, mozhi (language) matrum password settings.',
    profile: 'Profile (சுயவிவரம்)',
    preferences: 'Preferences (விருப்பங்கள்)',
    security: 'Security (பாதுகாப்பு)',
    language: 'Language (மொழி)',
    select_language: 'Mozhiyai Select Seiyya',
    business_name: 'Business Peyar',
    admin_name: 'Admin Peyar',
    email_address: 'Email Address',
    business_address: 'Kadai / Business Address',
    default_interest: 'Default Vatti Rate (%)',
    current_password: 'Ippo Ulla Password',
    new_password: 'Pudhiya Password',
    confirm_password: 'Pudhiya Password Confirm Seiyya',
    update_password: 'Password Update Seiyya',
    settings_saved: 'Settings nallaapadi save aagiduchu!',
    password_updated: 'Password pudhidhaaga maatriamaikkappattadhu!',
    language_saved: 'Mozhi matram database-il save aagiduchu!'
  }
};
